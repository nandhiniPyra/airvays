...
export const _createFlightBooking = (payload: any, callback: any) => {
  try {
    let request = {
      reqmethod: 'POST',
      url: 'createFlightBooking',
      param: {},
      reqdata: payload,
    };
    common(request)
...
export const _getFlightBookingList = (payload: any, callback: any) => {
  try {
    let request = {
      reqmethod: 'POST',
      url: 'flightBookingList',
      param: {},
      reqdata: payload,
    };
    common(request)
