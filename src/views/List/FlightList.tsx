              ...
              >
                ...
                {x.itineraries[0].segments.map((item: any) => (
                  <>
                    ...
                    <Grid container item xs={10} style={{ color: "#1C2460", marginTop: '15px', display: 'flex', justifyContent: 'space-between' }}>
                      <div>
                        <div>
                          <img
                      ...
                      <div>
                        {item.departure.at}
                        <br />
                        <Typography style={{ marginTop: '5px' }}>Chennai</Typography>
                        <br />
                        {item.departure.iataCode}
                      </div>
                      <div>
                        <Typography style={{ textAlign: 'center' }}>Direct</Typography>
                        <div style={{ display: "flex" }}>
                          {"-------------------------"}
                          <img src={flightIcon}></img>
                          {"-------------------------"}
                        </div>
                        <Typography style={{ marginTop: '5px', textAlign: 'center' }}>{x.itineraries[0].duration}</Typography>
                      </div>
                      <div>
                        {item.arrival.at}
                        <Typography style={{ marginTop: '5px' }}>  Bengaluru Intl</Typography>
                        <br />
