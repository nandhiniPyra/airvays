                    ...
                    <Grid container>
                      <Grid>
                        {selectedIndex === 0 ? (
                          <>
                            <img
                              style={{ color: '#33BBFF', marginTop: '10px' }}
                              alt=''
                              src={arrow}
                            />
                          </>
                      ...
                      <Grid style={{ marginLeft: '1%' }}>
                        <ListItem
                          ...
                          <ListItemIcon>
                            {selectedIndex === 4 ? (
                              <span>
                                <img alt='' src={cancellationIconlue} />
                              </span>
                            ) : (
                              <img alt='' src={cancellationIcon} />
                            )}
